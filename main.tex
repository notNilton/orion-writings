...
\include{textuais/01-introducao}
\include{textuais/02-refteorico}
\include{textuais/03-metodologia}
\include{textuais/04-resultados}
\include{textuais/05-conclusao}
...
\begin{appendices}
\appendix
\include{textuais/apendice/apendiceA}
\include{textuais/apendice/A-front-adjust-connection}
\include{textuais/apendice/A-front-canva-connect}
\include{textuais/apendice/A-front-hide-graph}
\include{textuais/apendice/A-front-hide-menu}
\include{textuais/apendice/A-front-node1-1}
\include{textuais/apendice/A-front-node1-2}
\include{textuais/apendice/A-front-node2-1}
\include{textuais/apendice/A-front-node2-2}
\include{textuais/apendice/A-front-reconcile}
\include{textuais/apendice/A-front-upload-csv}
\end{appendices}

\renewcommand{\appendixname}{Anexo}
\begin{appendices}
\appendix
% \include{textuais/anexo/anexoA}
\end{appendices}
